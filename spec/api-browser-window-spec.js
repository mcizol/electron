    ...
    describe('"sandbox" option', function () {
      ...
      it('releases memory after popup is closed', (done) => {
        ...
        ipcMain.once('answer', function (event, {bytesBeforeOpen, bytesAfterOpen, bytesAfterClose}) {
          ...
          // can't control, but considering that an empty sandboxed window
          // allocates about 20mb and tested popup allocates a 64mb byte array,
          // we can reasonably expect decrease to be at least 70% of increase
